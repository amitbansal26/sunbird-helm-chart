...
CREATE DATABASE api_manager_kong WITH TEMPLATE = template0 OWNER = postgres;
...
CREATE DATABASE opensaberdb WITH TEMPLATE = template0 OWNER = postgres;
CREATE DATABASE sunbird_programs WITH TEMPLATE = template0 OWNER = postgres;
